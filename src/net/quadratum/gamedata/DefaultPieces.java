...
public class DefaultPieces {
	...
	public static ArrayList<Piece> getPieces() {
		...
		movementBlock._bonuses.put(Block.BonusType.MOVEMENT, 
				Constants.MOVEMENT_MODIFIER / 4); // 4 for +1

		// Range block
		Block rangeBlock = new Block(50);
		rangeBlock._bonuses.put(Block.BonusType.RANGE, 
				Constants.ATTACK_RANGE_MODIFIER / 5); // 5 for +1

		// Sight block
		Block sightBlock = new Block(50);
		sightBlock._bonuses.put(Block.BonusType.SIGHT, 
				Constants.SIGHT_MODIFIER / 4); // 4 for +1
		...
		seerBlock._bonuses.put(Block.BonusType.SIGHT, 
				Constants.SIGHT_MODIFIER / 6); // 6 for +1
		seerBlock._bonuses.put(Block.BonusType.RANGE, 
				Constants.ATTACK_RANGE_MODIFIER / 6);
		...
		sentryBlock._bonuses.put(Block.BonusType.SIGHT, 
				Constants.SIGHT_MODIFIER / 5); // 5 for +1
		...
		// Laser block
		Block laserBlock = new Block(50);
		laserBlock._bonuses.put(Block.BonusType.ATTACK_WIDTH, 
				-2*(Constants.ATTACK_WIDTH_MODIFIER / 5)); // 5 for -2
		
		// Shotgun block
		Block shotgunBlock = new Block(40);
		shotgunBlock._bonuses.put(Block.BonusType.ATTACK_WIDTH, 
				Constants.ATTACK_WIDTH_MODIFIER / 3); // 6 for +2

		// Attack piece
		Piece attackPiece = new Piece(10, "Attack", 
				"Provides +120 damage (50 hp per block)");
		...
		// Movement piece
		Piece movementPiece = new Piece(40, "Movement", 
				"Provides +1 movement radius (50 hp per block)");
		...
		// Range piece
		Piece rangePiece = new Piece(30, "Range", 
				"Provides +1 range radius (50 hp per block)");
		...
		// Sight piece
		Piece sightPiece = new Piece(20, "Sight", 
				"Provides +1 sight radius (50 hp per block)");
		...
		// Defense piece
		Piece defensePiece = new Piece(30, "Defense", 
				"Provides +20 defense (100 hp per block)");
		...
		Piece waterPiece = new Piece(50, "Jesus", 
				"Allows the unit to walk on water - resurrection not included (30 hp per block)");
		...
		// Seer piece
		Piece seerPiece = new Piece(110, "Seer", 
				"Provides +1 sight and range radius (35 hp per block)");
		...
		// Archer piece
		Piece archerPiece = new Piece(100, "Archer", 
				"Provides +84 attack and +1 range radius (40 hp per block)");
		...
		// Beserker piece
		Piece beserkerPiece = new Piece(150, "Beserker", 
				"Provides +75 attack and +20 defense (55 hp per block)");
		...
		// Sentry piece
		Piece sentryPiece = new Piece(130, "Guard", 
				"Provides +1 sight radius and +20 defense (45 hp per block)");
		...
		// Scout piece
		Piece scoutPiece = new Piece(110, "Scout", 
				"Provides +1 sight and movement radius (30 hp per block)");
		...
		// Blitzkreig piece
		Piece blitzkreigPiece = new Piece(150, "Blitzkreig", 
				"Provides +120 attack and +1 movement radius (40 hp per block)");
		...
		// Laser piece
		Piece laserPiece = new Piece(70, "Laser", 
				"Concentrates attack power (50 hp per block)");
		laserPiece.addBlock(new MapPoint(0,0), new Block(laserBlock));
		laserPiece.addBlock(new MapPoint(0,1), new Block(laserBlock));
		laserPiece.addBlock(new MapPoint(0,2), new Block(laserBlock));
		laserPiece.addBlock(new MapPoint(0,3), new Block(laserBlock));
		laserPiece.addBlock(new MapPoint(0,4), new Block(laserBlock));
		pieces.add(laserPiece);
		
		// Shotgun piece
		Piece shotgunPiece = new Piece(70, "Shotgun", 
				"Spreads out attack power (40 hp per block)");
		shotgunPiece.addBlock(new MapPoint(0,0), new Block(shotgunBlock));
		shotgunPiece.addBlock(new MapPoint(1,0), new Block(shotgunBlock));
		shotgunPiece.addBlock(new MapPoint(2,0), new Block(shotgunBlock));
		shotgunPiece.addBlock(new MapPoint(3,0), new Block(shotgunBlock));
		shotgunPiece.addBlock(new MapPoint(1,1), new Block(shotgunBlock));
		shotgunPiece.addBlock(new MapPoint(3,1), new Block(shotgunBlock));
		pieces.add(shotgunPiece);
